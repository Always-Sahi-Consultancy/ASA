...
const Register = () => {
    ...
    return (
        ...
        <div className='register'>
            <div className='register__title'>Register to Always Sahi</div>
            {data.map((content) => <RegisterComponent name={content.name} logo={content.logo} link={content.link} Content={content.Content} ids={content.ids} />)}
            <div className='register__alternative'>
                <div className='register__bar'></div>
