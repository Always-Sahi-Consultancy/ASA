...
function PhotoTestContainer(){
    const images=[
        ...
        },
        {
            id:'p2',
            name:'Bharat Kamble',
            text:"I understand what you have taught me.The notes you provide to us are very useful.You do not need to make any changes in the course. You teach perfectly.What I have learned is very useful in the CA firm internship you have given.I want to give you 5 out of 5 stars.",
        },
        {
            id:'p3',
            name:'Prashant',
