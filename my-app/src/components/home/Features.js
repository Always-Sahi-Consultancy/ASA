    ...
    return(
        ...
        <div className="features">
            <div className="features__points">
                <img src={Feature1} alt="Point 1"  className="img_fit"/>
            ...
            <div className="features__points">
                <img src={Feature2} alt="Point 2" className="img_fit"/>
            ...
            <div className="features__points">
                <img src={Feature3} alt="Point 3" className="img_fit"/>
            ...
            <div className="features__points last__point">
                <img src={Feature9} alt="Point 9" className="img_fit"/>
